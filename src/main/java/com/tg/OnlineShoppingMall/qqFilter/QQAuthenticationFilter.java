package com.tg.OnlineShoppingMall.qqFilter;
...
public class QQAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
     ...
     * client_id 由腾讯提供
     */
    static final String clientId = "101579436";

    /**
     * client_secret 由腾讯提供
     */
    private final static String clientSecret = "e49e1f0c729888b33a630383d7b3c97c";

    /**
     * redirect_uri 腾讯回调地址
     */
    private final static String redirectUri = "http://www.followt.xin/qqLogin";
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException, IOException, ServletException {
        ...
        System.out.println(JSON.toJSONString(qqToken)+"这是qqToken");
        if (qqToken != null){
